      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarHeader">
          ...
          <div>
            ...
            <a href="registro.php" class="btn btn-primary" name="registrarse"> <i class="bi bi-person-add"></i> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-add" viewBox="0 0 16 16">
